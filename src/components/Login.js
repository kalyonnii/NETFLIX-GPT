    ...
    if (!isSignInForm) {
      ...
      createUserWithEmailAndPassword(
        ...
        .then((userCredential) => {
          ...
          updateProfile(user, {
            displayName: name.current.value, photoURL: "https://avatars.githubusercontent.com/u/91622057?v=4"
          }).then(() => {
  ...
  return (
    <div>
      ...
      <form
        ...
        className="absolute   w-3/12 p-12 mt-32 bg-black mx-auto right-0 left-0 text-white rounded-lg bg-opacity-80"
      >
